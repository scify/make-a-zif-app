        ...
        <tr>
          ...
          <td>
            <span
              ...
              v-tooltip.right="getMetal(this.metal).title"
            ></span>
          </td>
          ...
          <td
            ...
            v-tooltip.right="getGroup(this.group1).title"
          ></td>
          <td
            v-html="getGroup(this.group2).name"
            v-tooltip.right="getGroup(this.group2).title"
          ></td>
          <td
            v-html="getGroup(this.group3).name"
            v-tooltip.right="getGroup(this.group3).title"
          ></td>
          <td></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            ...
            <span
              ...
              v-tooltip="
                `Is this the ZIF's aperture? If yes, it should be out of this table. On this table, this value is interpreted like 'The aperture's length is 3.46' which does not make sense.`
              "
              >?</span
            >
          </td>
